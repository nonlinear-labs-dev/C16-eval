...
static inline int32_t InterpolateSegment(int32_t const x0, int32_t const y0,
                                         int32_t const x1, int32_t const y1, int32_t const x)
{
  if (x <= x0)
    return y0;
  if (x >= x1)
    return y1;
  return y0 + (int32_t)((int64_t)(x - x0) * (int64_t)(y1 - y0) / (int64_t)(x1 - x0));
}
